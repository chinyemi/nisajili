                ...
                <ul class="nav side-menu">
                 <li><a><i class="glyphicon glyphicon-th"></i>System Reports<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu"> 
                        ...
                        <li><a href="System_Rates.php?pageID=SysRates&Id=<?php echo $Id;?>&Year=<?php echo $CurrYear;?>">Collection | Reports</a></li>
                        
                          <li><a href="PageSelector.php?pageID=SysRates&Id=<?php echo $Id;?>&Year=<?php echo $CurrYear;?>">General Expenses | Reports</a></li>
