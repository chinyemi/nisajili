...
if(isset($_POST["operation"]))
{
	if($_POST["operation"] == "Add")
	{
		...
		INSERT INTO vw_PaymentOptions_Manual (GatewayName, Currency,Toggle,GatwayMobile,GatewayEmail,GatwayAddress,Description,Type,GatewayKey,GatewaySecret) 
	...
	if($_POST["operation"] == "Edit")
	{
		...
		$statement = $connection->prepare(
			"UPDATE vw_PaymentOptions_Manual 
		...
		$ClosePayment=mysqli_query($conn,"UPDATE vw_PaymentOptions_Manual SET Toggle='NO' WHERE GatewayID <> '".$_POST["GatewayID"]."'");
