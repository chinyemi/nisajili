...
$Event = "Budget Expenses for ".PROJECT_NAME."(".$rowSiteInfo['sitename'].") at ".$rowSiteInfo['sitevenue']." on ".$rowSiteInfo['eventtype'];
	
	
} else {
	
$Event = "Budget Expenses  for ".PROJECT_NAME."(".$rowSiteInfo['sitename'].") at ".$rowSiteInfo['sitevenue']." on previous year";
...
$('#example').dataTable( {
 "aProcessing": true,
 "aServerSide": true,
"ajax": "budgetexpense_reports_proc.php?Id=<?php echo $Id;?>&Year=<?php echo $CurrYear;?>&ReportID=<?php echo $ReportID; ?>",
} );
} );
