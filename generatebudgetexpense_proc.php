...
<?php
	...
	if (isset($_POST["submit"])) {
		...
		CreateDBVeiwsBudgetExpense($_POST['Season']);
	
$result='<div class="alert alert-success">Dashboard tabular site reports for Budget Expense generated!</div>';
  	...
  	<div class="container">
  		<div class="row">
  			<div class="col-md-6 col-md-offset-3">
				...
				<form class="form-horizontal" role="form" method="post" action="generatebudgetexpense_proc.php?Id=<?php echo $Id;?>">
		 ...
		 <?php while ($rowseason=mysqli_fetch_array($getseason)) { ?>
          ...
          <?php }?>
						...
						<div class="col-sm-10 col-sm-offset-2" align="center">
							<input id="submit" name="submit" type="submit" value="Generate  Site Budget Expenses  Reports" class="btn btn-primary">
						</div>
					</div>
