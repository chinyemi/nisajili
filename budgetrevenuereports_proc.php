...
header("location: budgetrevenue_reports.php?Id=".$Id."&Year=".$Season."&ReportID=".$Site."_".$Season);
//exit();
...
<html lang="en">
  ...
  <h3 align="center">Generate Budget Revenue Reports</h3>

  	<div class="container">
  		<div class="row">
  			<div class="col-md-6 col-md-offset-3">
  				
			<form class="form-horizontal" role="form" method="post" action="budgetrevenuereports_proc.php?Id=<?php echo $Id;?>">
