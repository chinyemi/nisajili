...
$query = '';
$output = array();
$query .= "SELECT `GatewayID`,`GatewayName`,`Currency`,`Toggle`,`GatwayMobile`,`GatewayEmail`,`GatwayAddress`,`Description`,`Type`,`GatewayKey`,`GatewaySecret` FROM `PaymentOptions` ";
