...
$query = '';
$output = array();
$query .= "SELECT `GatewayID`,`GatewayName`,`Currency`,`Toggle`,`GatwayMobile`,`GatewayEmail`,`GatwayAddress`,`Description`,`Type`,`GatewayKey`,`GatewaySecret` 
FROM paymentoptions ";
if(isset($_POST["search"]["value"]))
{
	$query .= 'WHERE Year LIKE "%'.$_POST["search"]["value"].'%" ';
	$query .= 'OR GatewayName LIKE "%'.$_POST["search"]["value"].'%" ';
