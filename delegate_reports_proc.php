...
$CurrYear=$_GET['Year'];
    ...
    $aColumns = array('delegateID','fullname','mobile','email','organization','ticketNo','datereg','amount','package','checkedin','ticket_paid');
  ...
  $rowSiteInfo=mysqli_fetch_array($getSiteInfo);	
    ...
    $sTable = "vw_delegate_".$CurrYear."_".$rowSiteInfo['sitename'];
   } 
