		...
		<form method="post" id="date_form" enctype="multipart/form-data">
			<div class="modal-content">
		  	...
		  	<label>Send SMS</label>
					...
					<?php
					 $result=mysqli_query($conn,"select current_balance from sms_rate where rate_id=3");
		 ...
		 ?>
				...
				<div class="modal-footer">
					<input type="hidden" name="sms_id" id="sms_id" />
						<input type="hidden" name="rateid" id="rateid"value="3" />
