...
(4, 'expenses1', 100000.00, '2019-05-17', 'sdgagsagasg', 'Blantyre', '2019');
...
(3, 'Operational', 99999999.99, '2019-05-16', 'kkk;k;pk;k', 'Lilongwe', '2020');
...
INSERT INTO `packageinfo` (`id`, `package_name`, `paid_nocash`, `remarks`, `toggle`) VALUES
(1, 'Student', 'NO', 'Students', 'YES'),
(2, 'Normal', 'YES', 'Normal', 'YES'),
(3, 'VIP', 'YES', 'VIP', 'YES'),
(4, 'Complimentary', 'NO', 'Complimentary', 'YES'),
(5, 'Sponsored', 'NO', 'Sponsored', 'YES'),
(6, 'Volunteer', 'NO', 'Volunteer', 'YES'),
(7, 'Official', 'NO', 'Official', 'YES'),
(8, 'Delegate', 'NO', 'Delegate', 'YES'),
(9, 'Exhibitor', 'NO', 'Exhibitor', 'YES');
...
CREATE TABLE `PaymentOptions` (
  `GatewayID` int(5) NOT NULL,
  `GatewayName` varchar(250) DEFAULT NULL,
  `Currency` varchar(15) DEFAULT NULL,
  `Toggle` varchar(4) DEFAULT NULL,
  `GatwayMobile` varchar(20) DEFAULT NULL,
  `GatewayEmail` varchar(30) DEFAULT NULL,
  `GatwayAddress` varchar(100) DEFAULT NULL,
  `Description` varchar(100) DEFAULT NULL,
  `Type` varchar(10) DEFAULT NULL,
  `GatewayKey` varchar(255) DEFAULT NULL,
  `GatewaySecret` varchar(255) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `PaymentOptions` (`GatewayID`, `GatewayName`, `Currency`, `Toggle`, `GatwayMobile`, `GatewayEmail`, `GatwayAddress`, `Description`, `Type`, `GatewayKey`, `GatewaySecret`) VALUES
(1, 'PesaPal', 'MKW', 'NO', NULL, NULL, NULL, 'PesaPal ', 'Online', 'UEaA8jHd3CjINQ3k1F3M5ZZDZz3km1p+', 'qb6hPIdrzt6Y3Py5u7pzjprjpJw='),
(2, 'DPO', 'MKW', 'NO', NULL, NULL, NULL, 'DirectPay', 'Online', 'AE5614A8-2436-4B01-B506-AB60DC235239', NULL),
(13, 'Manual', 'MKW', 'YES', NULL, NULL, NULL, 'Manual', 'Manual', NULL, NULL);
...
--
-- Stand-in structure for view `vw_actualexpenses_2018_Blantyre`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_actualexpenses_2018_Blantyre`;
CREATE TABLE `vw_actualexpenses_2018_Blantyre` (
`expenseID` int(5)
,`Type` varchar(50)
,`Amount` double(10,2)
,`DateRecorded` date
...
--
-- Stand-in structure for view `vw_actualexpenses_2018_Lilongwe`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_actualexpenses_2018_Lilongwe`;
CREATE TABLE `vw_actualexpenses_2018_Lilongwe` (
`expenseID` int(5)
,`Type` varchar(50)
,`Amount` double(10,2)
,`DateRecorded` date
...
--
-- Stand-in structure for view `vw_actualrevenue_2020_Blantyre`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_actualrevenue_2020_Blantyre`;
CREATE TABLE `vw_actualrevenue_2020_Blantyre` (
`revenueID` int(11)
,`Type` varchar(50)
,`Amount` double(10,2)
,`DateRecorded` date
...
--
-- Stand-in structure for view `vw_actualrevenue_2020_Lilongwe`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_actualrevenue_2020_Lilongwe`;
CREATE TABLE `vw_actualrevenue_2020_Lilongwe` (
`revenueID` int(11)
,`Type` varchar(50)
,`Amount` double(10,2)
,`DateRecorded` date
...
--
-- Stand-in structure for view `vw_budgetrevenue_2018_Blantyre`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_budgetrevenue_2018_Blantyre`;
CREATE TABLE `vw_budgetrevenue_2018_Blantyre` (
`Type` varchar(50)
,`Amount` double(10,2)
,`DateRecorded` date
,`Description` varchar(250)
...
--
-- Stand-in structure for view `vw_budgetrevenue_2018_Lilongwe`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_budgetrevenue_2018_Lilongwe`;
CREATE TABLE `vw_budgetrevenue_2018_Lilongwe` (
`Type` varchar(50)
,`Amount` double(10,2)
,`DateRecorded` date
,`Description` varchar(250)
...
--
-- Stand-in structure for view `vw_PaymentOptions_Manual`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_PaymentOptions_Manual`;
CREATE TABLE `vw_PaymentOptions_Manual` (
`GatewayID` int(5)
,`GatewayName` varchar(250)
,`Currency` varchar(15)
,`Toggle` varchar(4)
,`GatwayMobile` varchar(20)
,`GatewayEmail` varchar(30)
,`GatwayAddress` varchar(100)
,`Description` varchar(100)
,`Type` varchar(10)
,`GatewayKey` varchar(255)
,`GatewaySecret` varchar(255)
);

-- --------------------------------------------------------

--
-- Stand-in structure for view `vw_PaymentOptions_Online`
-- (See below for the actual view)
--
DROP VIEW IF EXISTS `vw_PaymentOptions_Online`;
CREATE TABLE `vw_PaymentOptions_Online` (
`GatewayID` int(5)
,`GatewayName` varchar(250)
,`Currency` varchar(15)
,`Toggle` varchar(4)
...
(6, 'Danielle<br> Strickland', 'Pastor; Author;', 'Justice Advocate', 'Danielle Strickland has led churches, started training schools and established justice departments around the world.She spent 22 years as an officer in The Salvation Army and is an Ambassador for Stop The Traffik.With a deep calling to empower people and to transform neighborhoods and the world, she co-founded Infinitum (a way of life), Brave Global, Amplify Peace and the Women Speakers Collective.Strickland is the author of several books, including The Ultimate Exodus.', '', '', '', 'danielle2.jpg', 'danielle_small.jpg', 3, 2),
...
(1, 'main video', 'https://www.youtube.com/embed/qKyc0_UdN8k', 'faculty_malawi.png', 'The diverse Summit faculty delivers a unique blend of vision, inspiration and practical skills you can immediately apply.'),
(3, 'who video', 'https://www.youtube.com/embed/ntGbBxyPTlE', 'whoweare.png', 'Learn more about our mission and vision.'),
(4, 'highlights video', 'https://www.youtube.com/embed/2WAFOKpeZOs', '2018_highlights.png', 'Watch highlights from the 2018 Summit.');

-- --------------------------------------------------------

--
-- Structure for view `vw_actualexpenses_2018_Blantyre`
--
DROP TABLE IF EXISTS `vw_actualexpenses_2018_Blantyre`;

CREATE ALGORITHM=UNDEFINED DEFINER=`afyapopo_glsmw`@`localhost` SQL SECURITY DEFINER VIEW `vw_actualexpenses_2018_Blantyre`  AS  (select `actual_expenses`.`expenseID` AS `expenseID`,`actual_expenses`.`Type` AS `Type`,`actual_expenses`.`Amount` AS `Amount`,`actual_expenses`.`DateRecorded` AS `DateRecorded`,`actual_expenses`.`Description` AS `Description`,`actual_expenses`.`Site` AS `Site`,`actual_expenses`.`glsyear` AS `glsyear` from `actual_expenses` where ((`actual_expenses`.`glsyear` = '2018') and (`actual_expenses`.`Site` = 'Blantyre'))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_actualexpenses_2018_Lilongwe`
--
DROP TABLE IF EXISTS `vw_actualexpenses_2018_Lilongwe`;

CREATE ALGORITHM=UNDEFINED DEFINER=`afyapopo_glsmw`@`localhost` SQL SECURITY DEFINER VIEW `vw_actualexpenses_2018_Lilongwe`  AS  (select `actual_expenses`.`expenseID` AS `expenseID`,`actual_expenses`.`Type` AS `Type`,`actual_expenses`.`Amount` AS `Amount`,`actual_expenses`.`DateRecorded` AS `DateRecorded`,`actual_expenses`.`Description` AS `Description`,`actual_expenses`.`Site` AS `Site`,`actual_expenses`.`glsyear` AS `glsyear` from `actual_expenses` where ((`actual_expenses`.`glsyear` = '2018') and (`actual_expenses`.`Site` = 'Lilongwe'))) ;
...
--
-- Structure for view `vw_actualrevenue_2020_Blantyre`
--
DROP TABLE IF EXISTS `vw_actualrevenue_2020_Blantyre`;

CREATE ALGORITHM=UNDEFINED DEFINER=`afyapopo_glsmw`@`localhost` SQL SECURITY DEFINER VIEW `vw_actualrevenue_2020_Blantyre`  AS  (select `actual_revenue`.`revenueID` AS `revenueID`,`actual_revenue`.`Type` AS `Type`,`actual_revenue`.`Amount` AS `Amount`,`actual_revenue`.`DateRecorded` AS `DateRecorded`,`actual_revenue`.`Description` AS `Description`,`actual_revenue`.`Site` AS `Site`,`actual_revenue`.`glsyear` AS `glsyear` from `actual_revenue` where ((`actual_revenue`.`glsyear` = '2020') and (`actual_revenue`.`Site` = 'Blantyre'))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_actualrevenue_2020_Lilongwe`
--
DROP TABLE IF EXISTS `vw_actualrevenue_2020_Lilongwe`;

CREATE ALGORITHM=UNDEFINED DEFINER=`afyapopo_glsmw`@`localhost` SQL SECURITY DEFINER VIEW `vw_actualrevenue_2020_Lilongwe`  AS  (select `actual_revenue`.`revenueID` AS `revenueID`,`actual_revenue`.`Type` AS `Type`,`actual_revenue`.`Amount` AS `Amount`,`actual_revenue`.`DateRecorded` AS `DateRecorded`,`actual_revenue`.`Description` AS `Description`,`actual_revenue`.`Site` AS `Site`,`actual_revenue`.`glsyear` AS `glsyear` from `actual_revenue` where ((`actual_revenue`.`glsyear` = '2020') and (`actual_revenue`.`Site` = 'Lilongwe'))) ;
...
--
-- Structure for view `vw_budgetrevenue_2018_Blantyre`
--
DROP TABLE IF EXISTS `vw_budgetrevenue_2018_Blantyre`;

CREATE ALGORITHM=UNDEFINED DEFINER=`afyapopo_glsmw`@`localhost` SQL SECURITY DEFINER VIEW `vw_budgetrevenue_2018_Blantyre`  AS  (select `budget_revenue`.`Type` AS `Type`,`budget_revenue`.`Amount` AS `Amount`,`budget_revenue`.`DateRecorded` AS `DateRecorded`,`budget_revenue`.`Description` AS `Description`,`budget_revenue`.`Site` AS `Site`,`budget_revenue`.`revenueID` AS `revenueID`,`budget_revenue`.`glsyear` AS `glsyear` from `budget_revenue` where ((`budget_revenue`.`glsyear` = '2018') and (`budget_revenue`.`Site` = 'Blantyre'))) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_budgetrevenue_2018_Lilongwe`
--
DROP TABLE IF EXISTS `vw_budgetrevenue_2018_Lilongwe`;

CREATE ALGORITHM=UNDEFINED DEFINER=`afyapopo_glsmw`@`localhost` SQL SECURITY DEFINER VIEW `vw_budgetrevenue_2018_Lilongwe`  AS  (select `budget_revenue`.`Type` AS `Type`,`budget_revenue`.`Amount` AS `Amount`,`budget_revenue`.`DateRecorded` AS `DateRecorded`,`budget_revenue`.`Description` AS `Description`,`budget_revenue`.`Site` AS `Site`,`budget_revenue`.`revenueID` AS `revenueID`,`budget_revenue`.`glsyear` AS `glsyear` from `budget_revenue` where ((`budget_revenue`.`glsyear` = '2018') and (`budget_revenue`.`Site` = 'Lilongwe'))) ;
...
--
-- Structure for view `vw_PaymentOptions_Manual`
--
DROP TABLE IF EXISTS `vw_PaymentOptions_Manual`;

CREATE ALGORITHM=UNDEFINED DEFINER=`afyapopo_glsmw`@`localhost` SQL SECURITY DEFINER VIEW `vw_PaymentOptions_Manual`  AS  (select `PaymentOptions`.`GatewayID` AS `GatewayID`,`PaymentOptions`.`GatewayName` AS `GatewayName`,`PaymentOptions`.`Currency` AS `Currency`,`PaymentOptions`.`Toggle` AS `Toggle`,`PaymentOptions`.`GatwayMobile` AS `GatwayMobile`,`PaymentOptions`.`GatewayEmail` AS `GatewayEmail`,`PaymentOptions`.`GatwayAddress` AS `GatwayAddress`,`PaymentOptions`.`Description` AS `Description`,`PaymentOptions`.`Type` AS `Type`,`PaymentOptions`.`GatewayKey` AS `GatewayKey`,`PaymentOptions`.`GatewaySecret` AS `GatewaySecret` from `PaymentOptions` where (`PaymentOptions`.`Type` = 'Manual')) ;

-- --------------------------------------------------------

--
-- Structure for view `vw_PaymentOptions_Online`
--
DROP TABLE IF EXISTS `vw_PaymentOptions_Online`;

CREATE ALGORITHM=UNDEFINED DEFINER=`afyapopo_glsmw`@`localhost` SQL SECURITY DEFINER VIEW `vw_PaymentOptions_Online`  AS  (select `PaymentOptions`.`GatewayID` AS `GatewayID`,`PaymentOptions`.`GatewayName` AS `GatewayName`,`PaymentOptions`.`Currency` AS `Currency`,`PaymentOptions`.`Toggle` AS `Toggle`,`PaymentOptions`.`GatwayMobile` AS `GatwayMobile`,`PaymentOptions`.`GatewayEmail` AS `GatewayEmail`,`PaymentOptions`.`GatwayAddress` AS `GatwayAddress`,`PaymentOptions`.`Description` AS `Description`,`PaymentOptions`.`Type` AS `Type`,`PaymentOptions`.`GatewayKey` AS `GatewayKey`,`PaymentOptions`.`GatewaySecret` AS `GatewaySecret` from `PaymentOptions` where (`PaymentOptions`.`Type` = 'Online')) ;
...
--
ALTER TABLE `actual_expenses`
  MODIFY `expenseID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `budget_expensetype`
  MODIFY `exptypeID` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `PaymentOptions`
  MODIFY `GatewayID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
