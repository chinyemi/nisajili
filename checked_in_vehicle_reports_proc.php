...
$CurrYear=$_GET['Year'];
    ...
    $aColumns = array('delegateID','fullname','gender','mobile','email','package','checkedin','gatepass','vehicletype','registrationnum','glsyear','glssite');
  ...
  $rowSiteInfo=mysqli_fetch_array($getSiteInfo);	
    ...
    $sTable = "vw_delegate_".$CurrYear."_".$rowSiteInfo['sitename']."_CarParking";
   } 
    ...
    $sQuery = "
        ...
        $sLimit
    ";
    $rResult = mysqli_query( $conn,$sQuery ) or fatal_error( 'MySQL Error: ' . mysql_errno($conn) );
