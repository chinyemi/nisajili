...
<html>
	...
	<body>
		<div class="container box">
			<h1 align="center">Manage | Site Actual Revenues</h1>
			
			<div class="table-responsive">
				
				<div align="left">
					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info btn-lg">Add Actual Revenue</button>
				</div>
				<br/>
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Add Actual Revenue</h4>
				</div>
...
$(document).ready(function(){
	...
	var dataTable = $('#user_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"fetchActualRevenue.php?Id=<?php echo $Id;?>",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('submit', '#user_form', function(event){
		...
		{
			$.ajax({
				url:"insertActualRevenue.php?Id=<?php echo $Id;?>",
				method:'POST',
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			url:"fetch_singleActualRevenue.php?Id=<?php echo $Id;?>",
			method:"POST",
	...
	$(document).on('click', '.delete', function(){
		...
		{
			$.ajax({
				url:"deleteActualRevenue.php?Id=<?php echo $Id;?>",
				method:"POST",
				data:{revenueID:revenueID},
				success:function(data)
				{
