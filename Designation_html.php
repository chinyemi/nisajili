...
<html>
	...
	<body>
		<div class="container box">
			<h1 align="center">Manage | Designation</h1>
			
			<div class="table-responsive">
				
				<div align="left">
					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info btn-lg">Add Designation</button>
				</div>
				<br/>
...
$(document).ready(function(){
	...
	var dataTable = $('#user_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"fetchDesignation.php?Id=<?php echo $Id;?>",
			type:"POST"
		},
		"columnDefs":[
			{
