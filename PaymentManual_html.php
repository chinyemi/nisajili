...
<html>
	...
	<body>
		<div class="container box">
			<h1 align="center">Payment | Manual</h1>
			
			<div class="table-responsive">
				
				<div align="left">
					<button type="button" id="add_button" data-toggle="modal" data-target="#userModal" class="btn btn-info btn-lg">Add Manual Payment </button>
				</div>
				<br/>
...
$(document).ready(function(){
	$('#add_button').click(function(){
		$('#user_form')[0].reset();
		$('.modal-title').text("Add Mannual Payment");
		$('#action').val("Add");
		$('#operation').val("Add");
	...
	var dataTable = $('#user_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"fetchPaymentManual.php?Id=<?php echo $Id;?>",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('submit', '#user_form', function(event){
		...
		{
			$.ajax({
				url:"insertPaymentManual.php?Id=<?php echo $Id;?>",
				method:'POST',
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			url:"fetch_singlePaymentManual.php?Id=<?php echo $Id;?>",
			method:"POST",
			...
			success:function(data)
			{
				...
				$('.modal-title').text("Edit Manual Payment");
	...
	$(document).on('click', '.delete', function(){
		...
		{
			$.ajax({
				url:"deletePaymentManual.php?Id=<?php echo $Id;?>",
				method:"POST",
				data:{GatewayID:GatewayID},
				success:function(data)
				{
