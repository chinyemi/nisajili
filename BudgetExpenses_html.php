			...
			<div class="modal-content">
				...
				<div class="modal-body">
        			...
        			<option selected disabled>--Select Type--</option>
  					<option value="Advertising Budget">Advertising Budget</option>
  					<option value="Delivery Budget">Delivery Budget</option>
 	                <option value="Rent Budget">Rent Budget</option>
 	                <option value="Salaries Budget ">Salaries Budget</option>
 	                <option value="Telecommunications Budget">Telecommunications Budget</option>
					</select>
					<br />
					<label>Amount</label>
